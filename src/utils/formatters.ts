...
export const i18n = {
  en: {
    ...
    previewReport: 'Preview Full PDF Report',
    previewVoucher: 'Preview Voucher PDF',
    printPdf: 'Print Document',
    downloadPdf: 'Download PDF',
    exportPersonCsv: 'Export Person CSV',
    exportPersonPdf: 'Export Person PDF',
    previewPersonPdf: 'Preview Voucher Slip',
  ...
  hi: {
    ...
    previewPdf: 'PDF प्रिव्यू',
    previewReport: 'पूरी PDF रिपोर्ट प्रिव्यू',
    previewVoucher: 'PDF वाउचर प्रिव्यू',
    printPdf: 'प्रिंट करें',
    downloadPdf: 'PDF डाउनलोड',
    exportPersonCsv: 'खाता CSV',
    exportPersonPdf: 'खाता PDF वाउचर',
    previewPersonPdf: 'PDF वाउचर प्रिव्यू',
